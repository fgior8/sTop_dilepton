...
// Tue Aug 30 11:14:52 2016 by ROOT version 6.06/01
// from TTree tree/treeProducerSusyMultilepton
// found on file: /gpfs/csic_projects/cms/palencia/heppyTrees/HeppyTreesDR80X/v1/Tree_Data_Powheg_ext_0.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         LepGood_mcPx[5];   //[nLepGood]
   Float_t         LepGood_mcPy[5];   //[nLepGood]
   Float_t         LepGood_mcPz[5];   //[nLepGood]
   Float_t         LepGood_mcEnergy[5];   //[nLepGood]
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/gpfs/csic_projects/cms/palencia/heppyTrees/HeppyTreesDR80X/v1/Tree_Data_Powheg_ext_0.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/gpfs/csic_projects/cms/palencia/heppyTrees/HeppyTreesDR80X/v1/Tree_Data_Powheg_ext_0.root");
      }
