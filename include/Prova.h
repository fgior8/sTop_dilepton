...
// Tue Apr 21 11:20:45 2015 by ROOT version 5.34/02
// from TTree Tree/Tree
// found on file: /gpfs/csic_projects/tier3data/TreesPHYS14/PU20bx25/Tree_TTZJets.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/gpfs/csic_projects/tier3data/TreesPHYS14/PU20bx25/Tree_TTZJets.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/gpfs/csic_projects/tier3data/TreesPHYS14/PU20bx25/Tree_TTZJets.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/gpfs/csic_projects/tier3data/TreesPHYS14/PU20bx25/Tree_TTZJets.root:/demo");
