...
// Tue Oct 13 22:11:20 2015 by ROOT version 5.34/02
// from TTree tree/treeProducerSusyMultilepton
// found on file: treeTtbar_oct13.root
//////////////////////////////////////////////////////////
...
public :
   ...
   Float_t         FatJet_corr_JECUp[4];   //[nFatJet]
   Float_t         FatJet_corr_JECDown[4];   //[nFatJet]
   Float_t         FatJet_corr[4];   //[nFatJet]
   Float_t         FatJet_px[4];   //[nFatJet]
   Float_t         FatJet_py[4];   //[nFatJet]
   Float_t         FatJet_pz[4];   //[nFatJet]
   Float_t         FatJet_energy[4];   //[nFatJet]
   ...
   Float_t         LepGood_jetPtRatio_LepAwareJEC[5];   //[nLepGood]
   ...
   Float_t         LepGood_px[5];   //[nLepGood]
   Float_t         LepGood_py[5];   //[nLepGood]
   Float_t         LepGood_pz[5];   //[nLepGood]
   Float_t         LepGood_energy[5];   //[nLepGood]
   ...
   Float_t         LepGood_jetPt[5];   //[nLepGood]
   Float_t         LepGood_jetRawPt[5];   //[nLepGood]
   Float_t         LepGood_jetEta[5];   //[nLepGood]
   Float_t         LepGood_jetPhi[5];   //[nLepGood]
   Float_t         LepGood_jetE[5];   //[nLepGood]
   ...
   Float_t         LepGood_jetPtRatio_LepAwareJECv2[5];   //[nLepGood]
   ...
   Float_t         Jet_charge[12];   //[nJet]
   Float_t         Jet_area[12];   //[nJet]
   Float_t         Jet_qgl[12];   //[nJet]
   Float_t         Jet_ptd[12];   //[nJet]
   Float_t         Jet_axis2[12];   //[nJet]
   Int_t           Jet_mult[12];   //[nJet]
   Int_t           Jet_partonId[12];   //[nJet]
   Int_t           Jet_partonMotherId[12];   //[nJet]
   Float_t         Jet_nLeptons[12];   //[nJet]
   ...
   Float_t         Jet_px[12];   //[nJet]
   Float_t         Jet_py[12];   //[nJet]
   Float_t         Jet_pz[12];   //[nJet]
   Float_t         Jet_energy[12];   //[nJet]
   Float_t         Jet_pt[12];   //[nJet]
   Float_t         Jet_eta[12];   //[nJet]
   Float_t         Jet_phi[12];   //[nJet]
   Float_t         Jet_mass[12];   //[nJet]
   Float_t         Jet_prunedMass[12];   //[nJet]
   Int_t           Jet_mcNumPartons[12];   //[nJet]
   Int_t           Jet_mcNumLeptons[12];   //[nJet]
   Int_t           Jet_mcNumTaus[12];   //[nJet]
   Float_t         Jet_mcAnyPartonMass[12];   //[nJet]
   Int_t           Jet_nSubJets[12];   //[nJet]
   Int_t           Jet_nSubJets25[12];   //[nJet]
   Int_t           Jet_nSubJets30[12];   //[nJet]
   Int_t           Jet_nSubJets40[12];   //[nJet]
   Int_t           Jet_nSubJetsZ01[12];   //[nJet]
   Float_t         Jet_chHEF[12];   //[nJet]
   Float_t         Jet_neHEF[12];   //[nJet]
   Float_t         Jet_phEF[12];   //[nJet]
   Float_t         Jet_eEF[12];   //[nJet]
   Float_t         Jet_muEF[12];   //[nJet]
   Float_t         Jet_HFHEF[12];   //[nJet]
   Float_t         Jet_HFEMEF[12];   //[nJet]
   Int_t           Jet_chHMult[12];   //[nJet]
   Int_t           Jet_neHMult[12];   //[nJet]
   Int_t           Jet_phMult[12];   //[nJet]
   Int_t           Jet_eMult[12];   //[nJet]
   Int_t           Jet_muMult[12];   //[nJet]
   Int_t           Jet_HFHMult[12];   //[nJet]
   Int_t           Jet_HFEMMult[12];   //[nJet]
   Float_t         Jet_CorrFactor_L1[12];   //[nJet]
   Float_t         Jet_CorrFactor_L1L2[12];   //[nJet]
   Float_t         Jet_CorrFactor_L1L2L3[12];   //[nJet]
   Float_t         Jet_CorrFactor_L1L2L3Res[12];   //[nJet]
   ...
   TBranch        *b_LepGood_jetPtRatio_LepAwareJEC;   //!
   ...
   TBranch        *b_LepGood_jetPt;   //!
   TBranch        *b_LepGood_jetRawPt;   //!
   TBranch        *b_LepGood_jetEta;   //!
   TBranch        *b_LepGood_jetPhi;   //!
   TBranch        *b_LepGood_jetE;   //!
   ...
   TBranch        *b_LepGood_jetPtRatio_LepAwareJECv2;   //!
...
#ifdef trial_cxx
trial::trial(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("treeTtbar_oct13.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("treeTtbar_oct13.root");
      }
...
Int_t trial::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t trial::LoadTree(Long64_t entry)
{
...
void trial::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("LepGood_jetPtRatio_LepAwareJEC", LepGood_jetPtRatio_LepAwareJEC, &b_LepGood_jetPtRatio_LepAwareJEC);
   ...
   fChain->SetBranchAddress("LepGood_jetPt", LepGood_jetPt, &b_LepGood_jetPt);
   fChain->SetBranchAddress("LepGood_jetRawPt", LepGood_jetRawPt, &b_LepGood_jetRawPt);
   fChain->SetBranchAddress("LepGood_jetEta", LepGood_jetEta, &b_LepGood_jetEta);
   fChain->SetBranchAddress("LepGood_jetPhi", LepGood_jetPhi, &b_LepGood_jetPhi);
   fChain->SetBranchAddress("LepGood_jetE", LepGood_jetE, &b_LepGood_jetE);
   ...
   fChain->SetBranchAddress("LepGood_jetPtRatio_LepAwareJECv2", LepGood_jetPtRatio_LepAwareJECv2, &b_LepGood_jetPtRatio_LepAwareJECv2);
...
void trial::Show(Long64_t entry)
{
...
Int_t trial::Cut(Long64_t entry)
{
