...
void SignalPlots::Fill(UInt_t numberVertices, Float_t MET, Float_t MET_phi, std::vector<Lepton>& leptons, std::vector<Jet>& jets, Float_t weight, Int_t channel, Int_t cut) {
